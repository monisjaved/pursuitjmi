...
if($flag==0){
?>
<center></strong>You have the misfortune to own an unreliable clock.<br/> This one loses exactly 24 minutes every hour. <br/>It is now showing 3:00am and you know that is was correct at midnight, when you set it.<br/> The clock stopped 1 hour ago, what is the correct time now?<br/>(only time is required)</strong><form name="input" action="" method="post">
