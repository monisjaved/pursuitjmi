...
if($flag==0){
?>
<img src="https://saint.nseasy.com/~engineer/apps/crypt/level/Egypt Sphinx of Giza.jpg"/>
<center></strong>Which creature walks on four legs in the morning,<br/> two legs in the afternoon,<br/> and three legs in the evening?<br/>The answer is the key to the password</strong><form name="input" action="" method="post">
<strong>Password: </strong><input type="text" name="pass">
<input type="submit" value="Submit">
</form>
</center>
<!-- the answer lies within the txt ! -->
<?php } 
